    ...
    Public Class Watcher
        ...
        Public Shared Sub ClipboardListening()
            ...
            While Setup.Get("ToolDownloadClipboard")
                ...
                If Text.Contains("curseforge.com") Then 'www.curseforge.com/minecraft/mc-mods/jei
                    Slug = Text.Split("/")(3)
                    Try
                        ProjectId = DlModRequest("https://api.curseforge.com/v1/mods/search?gameId=432&slug=" + Slug, IsJson:=True)("data")(0)("id")
                    Catch ex As Exception
                        Log("[Clipboard] 获取剪贴板资源链接 ID 失败: " + ex.ToString(), LogLevel.Normal)
                        CurrentText = Text
                        Continue While
                    End Try
                    ...
                    Dim Comp As CompProjectRequest = Nothing
                ...
                ElseIf Text.Contains("modrinth.com") Then 'modrinth.com/mod/fabric-api
                    Slug = Text.Split("/")(2)
